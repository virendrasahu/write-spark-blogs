    ...
    const response = await fetch(
      `https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=${geminiApiKey}`,
      {
        ...
        body: JSON.stringify({
          contents: [{
            parts: [{
              text: `Generate a comprehensive blog post about: ${prompt}

Please structure the content as follows:
- Start with an engaging title (use # for the main heading)
- Include an introduction paragraph
- Use ## for section headings
- Add 3-4 main sections with detailed content
- Include bullet points or numbered lists where appropriate
- End with a conclusion
- Keep the tone professional but engaging
- Aim for 800-1200 words

Make sure the content is informative, well-structured, and ready to publish.`
            }]
          }],
          generationConfig: {
            temperature: 0.7,
